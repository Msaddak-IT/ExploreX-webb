...
class ReclamationControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'reclamation[datet_reclama]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setDatet_reclama('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'reclamation[datet_reclama]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDatet_reclama());
    }
